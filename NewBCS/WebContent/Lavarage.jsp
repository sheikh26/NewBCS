...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <FIELDSET>   <LEGEND><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-FAMILY: Verdana"> Manage Leverage</SPAN></LEGEND>
       
          
          <html:form action="/lavarage">
	...
	<center>
		...
		<table width="90%" bgcolor="white" border="0">
		 ...
		 <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
			...
			<tr>
				<td align="left" width="30%"><html:hidden property="leverageId" />
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="lavarage.gradeName" /><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:text property="gradeName" maxlength="50" />
	<html:errors property="gradeName" />
   </td>
	</tr>
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="lavarage.countryId"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:select styleClass="cselect" property="countryId">
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="lavarage.leveragePerc"/><font color="red">*</font>
		</td>
		<td align="left" width="30%">
			<html:text property="leveragePerc" maxlength="50"/>
	<html:errors property="leveragePerc" />
   </td>
	</tr>
	<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
	 <tr valign=top><td width="30%">&nbsp;</td>
			<td width="80%" align="left">
			<logic:notEqual value="Edit" property="edit" name="lavarageForm">
					<html:submit property="operation" styleClass="submit" value="Add" />
					<a href="displayLavarageList.do">
					<img src="images/cancel.JPG" width="45" height="22"  border="0" align="top"/>
					</a>
					</logic:notEqual>
					<logic:equal value="Edit" property="edit" name="lavarageForm">
