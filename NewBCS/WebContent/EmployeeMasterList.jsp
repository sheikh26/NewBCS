    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost"></p>
        <html:form action="/employeeMasterList" method="Post">
...
%>
<a  href="displayEmployeeMaster.do">Add a New Record
</a>
...
<table  width="100%"   cellpadding="1" cellspacing="1" 
			...
			<tr>
			<td>
		<display:table id="row" name="list1" requestURI="/displayEmployeeMasterList.do" 
					pagesize="10" class="common_table_class_caption"  cellpadding="0" cellspacing="0"  style="width:650px;">
		
		<td>	
			  	<display:column   title="Update" media="html">
			  	<a href="displayEmployeeMaster.do?edit=Edit&operation=Update&empId=<c:out  value="${row.empId}"/>">
				...
				<td>	
			  	...
			  	<a style="color: #f47920;" href="employeeMasterList.do?operation=Delete&empId=<c:out  value="${row.empId}"/>">
		 ...
		 <td>
			   	<display:column   title="Global Id" property="peopleSoftId" >
				</display:column>
			</td>
			 <td>
			 ...
			 <td>
			   	<display:column   title="Base Salary Annual(INR)" property="baseSalaryAnnual" >
				</display:column>
			</td>
			  <td>
			   	<display:column   title="DOJ" property="dateOfJoin" >
				</display:column>
			</td>
