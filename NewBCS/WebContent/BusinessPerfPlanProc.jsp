...
<%@page import="com.strutsLogin.dto.BusinessPerfPlanDTO"%>
<head>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Business Performance Plan</h2>
       <html:form  action="/oaipListBusinessProc" method="get">
	...
	<tr>
		...
		<td align="left" width="80%">
		 ...
		 <a  href="displayBusinessPerfPlan.do">Add a New Record
</a>
		<FIELDSET>   <LEGEND><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-FAMILY: Verdana">Business Performance Plan</SPAN></LEGEND>
   
		<html:form  action="/oaipListBusinessProc" method="post">
		
		<%
	List<BusinessPerfPlanDTO> list1 = (List) request.getAttribute("list1");
...
%>
		...
		<table  width="100%"  cellpadding="" cellspacing="" 
			...
			<tr>
			<td>
		<display:table id="data" name="list1" requestURI="/oaipListBusinessProc.do" 
			 ...
			 <td>	
			  	...
			  	<a style="color: #f47920;" href="displayBusinessPerfPlan.do?edit=Edit&operation=Update&buPerfPlanId=<c:out  value="${data.buPerfPlanId}"/>">
				...
				<td>	
			  	...
			  	<a style="color: #f47920;" href="businessPerfPlanList.do?operation=Delete&buPerfPlanId=<c:out  value="${data.buPerfPlanId}"/>">
