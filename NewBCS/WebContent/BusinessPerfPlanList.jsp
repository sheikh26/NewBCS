  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
       ...
       <html:form  action="/businessPerfPlanList" method="get">
	...
	<tr>
		...
		<td align="left" width="80%">
			<html:select styleClass="cselect" property="businessUnitId">
					<html:option value="">Select Business Unit</html:option>
						...
						<html:option value="1">Asia</html:option>
						<html:option value="2">CoEE</html:option>
						</html:select>
		...
		<html:form  action="/businessPerfPlanList" method="post">
...
%>
		...
		<table  width="100%"  cellpadding="" cellspacing="" 
			...
			<tr>
			<td>
		<display:table id="data" name="list1" requestURI="/businessPerfPlanList.do" 
