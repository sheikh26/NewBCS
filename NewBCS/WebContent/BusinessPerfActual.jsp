...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <FIELDSET>   <LEGEND><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-FAMILY: Verdana"> Manage Plan Actual</SPAN></LEGEND>
       
       <html:form  action="/businessPerfActual" onsubmit="CheckForm()">
	...
	<center>
		...
		<table width="90%" bgcolor="white" border="0">
		 ...
		 <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
			...
			<html:hidden property="businessPerfActualId" />
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.businessUnitId"/><font color="red">*</font>
		</td>
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.buYear"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
...
<html:errors property="buYear" />
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.buMonth"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:select styleClass="cselect" property="buMonth"> 
	...
	<html:errors property="buMonth" />
   </td>
	</tr>
	
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.metric1Name"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:text  styleId="metric1Name"  property="metric1Name"  maxlength="50" readonly="true"></html:text>
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.metric1PlanValue"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:text property="metric1PlanValue"  maxlength="50"/>
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.metric2Name"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.metric2PlanValue"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:text property="metric2PlanValue" maxlength="50"/>
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.metric3Name"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:text  styleId="metric3Name"  property="metric3Name"  maxlength="50" readonly="true">
			</html:text>
	...
	<tr>
		<td align="left" width="30%">
			<bean:message key="businessPerfActual.metric3PlanValue"/><font color="red">*</font>
		</td>
		<td align="left" width="80%">
			<html:text property="metric3PlanValue"  maxlength="50"/>
	...
	<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
			...
			<logic:notEqual value="Edit" property="edit" name="businessPerfActualForm">
					<html:submit property="operation" styleClass="submit" value="Add" />
					<a href="displayBusinessPerfActualList.do">
					<img src="images/cancel.JPG" width="45" height="22"  border="0" align="top"/>
					</a>
					</logic:notEqual>
					<logic:equal value="Edit" property="edit" name="businessPerfActualForm">
