...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Manage OAIP Yearly</h2>
       <html:form  action="/oaipListYearly" method="get">
...
<tr>
		<td align="left" width="30%">
			<bean:message key="displayOaipYearlyList.businessUnitId" />
		</td>
	...
	<tr>
		<td>
			<bean:message key="displayOaipYearlyList.year"/>
		</td>
		<td>
...
<html:submit property="operation" value="OK" />
		...
		<FIELDSET>   <LEGEND><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-FAMILY: Verdana">OAIP Yearly</SPAN></LEGEND>
   
		<html:form  action="/oaipListYearly" method="post">
...
%>
		...
		<table  width="100%"  cellpadding="" cellspacing="" 
			...
			<tr>
			<td>
		<display:table id="data" name="list1" requestURI="/oaipListYearly.do" 
			...
			<td>
			   	<display:column   title="Leverage" property="leverage" >
				</display:column>
			</td>
			...
			<td>
			   	<display:column   title="Performance" property="indPerf" >
				</display:column>
			</td>
			
			<td>
			   	<display:column   title="DOJ" property="doj" >
				</display:column>
			</td>
			
			<td>
			   	<display:column   title="Start Month" property="oaipStartMonth" >
				</display:column>
			</td>
			
			<td>
			   	<display:column   title="End Month" property="oaipEndMonth" >
				</display:column>
			</td>
