...
import java.util.*;
public class BusinessPerfPlanForm extends BaseForm {
	
	private String edit;
	
	private String buPerfPlanId;
	
	
	public String getBuPerfPlanId() {
		return buPerfPlanId;
	}
	public void setBuPerfPlanId(String buPerfPlanId) {
		this.buPerfPlanId = buPerfPlanId;
	}
...
dto.setBuPerfPlanId(DataUtil.getInteger(this.getBuPerfPlanId()));
...
String checkvalue=this.getMetric1Name();
...
public void populate(BaseDTO baseDTO) {
 BusinessPerfPlanDTO dto = (BusinessPerfPlanDTO)baseDTO;	
this.setBuPerfPlanId(DataUtil.getString(dto.getBuPerfPlanId()));
