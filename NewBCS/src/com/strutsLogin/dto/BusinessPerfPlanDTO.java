...
import java.util.*;
public class BusinessPerfPlanDTO extends BaseDTO implements DropDown{
	
	public String getDescription() {
		// TODO Auto-generated method stub
		return String.valueOf(this.buYear);
	}
	public String getKey() {
		// TODO Auto-generated method stub
		return String.valueOf(this.buPerfPlanId);
	}
	...
	private int buPerfPlanId;
	
	
	
	public int getBuPerfPlanId() {
		return buPerfPlanId;
	}
	public void setBuPerfPlanId(int buPerfPlanId) {
