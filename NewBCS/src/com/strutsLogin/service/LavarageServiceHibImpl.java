...
public class LavarageServiceHibImpl implements LavarageService {
	...
	public LavarageDTO get(int id) {
		...
		LavarageDTO dto = (LavarageDTO) session
				.get(LavarageDTO.class, id);
	...
	public List getList() {
		...
		Query q = s.createQuery("from LavarageDTO");
	...
	public List getList(SearchCriteria searchCriteria) {
		...
		Criteria criteria = s.createCriteria(LavarageDTO.class);
